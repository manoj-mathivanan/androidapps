...
public class all_steps extends ListActivity implements
com.sap.mobile.lib.sdmconnectivity.ISDMNetListener {
	...
	String collectionId = "TravelagencyCollection?$top=288";
	...
	{
		Intent crAgency = new Intent(all_steps.this, CreateAgency.class);
		startActivity(crAgency);
	}
	
	public synchronized void delentry()
	{
		String URL="http://ldcig8p.wdf.sap.corp:50018/sap/opu/odata/iwfnd/RMTSAMPLEFLIGHT/TravelagencyCollection('0000999')";
...
//        ((SDMBaseRequest) getSchema).setHeaders(curChildMap2);
	...
	{
		String collecUrl = "http://ldcig8p.wdf.sap.corp:50018/sap/opu/odata/iwfnd/RMTSAMPLEFLIGHT/"+collName;// "http://vmw3815.wdf.sap.corp:50009/sap/opu/sdata/iwfnd/RMTSAMPLEFLIGHT/"+collName;
